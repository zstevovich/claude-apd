...
| Builder maxTurns | `.claude/agents/*.md` frontmatter | Add `maxTurns: 60` (builders, v6.1) / `80` (reviewers, v6.1 B3) — bumps legacy 20/15/30/40 defaults |
...
APD gap analysis:
  ...
  ✗ maxTurns missing in builder agents — will add (60 builders / 80 reviewers)
  ✓ workflow.md exists
