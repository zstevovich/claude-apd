...
The reviewer agent is mandatory — every project gets one with `opus / max / plan / orange / maxTurns: 60`.
...
- The reviewer agent exists with `opus / max / plan / orange / maxTurns: 60`
